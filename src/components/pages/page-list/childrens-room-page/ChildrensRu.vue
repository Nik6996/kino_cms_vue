    ...
    <div class="card-page">
      <div class="card-page__content">
        ...
        <div class="card-page__description">
          <span>Описание</span>
          <textarea
            v-model="childrensRu.description"
          ...
          <div class="card-page__seo-block">
            ...
            <div class="card-page__seo-input">
              ...
              <p class="keywords">
                Keywords:
                <input
                  v-model="childrensRu.seoKeywords"
                  type="text"
                  placeholder="word"
                />
              </p>
              <p class="card-page__seo-description">
                Description:<textarea
                  v-model="childrensRu.seoDescription"
...
export default {
  data() {
    return {
      ...
      //   mainLocal: "",
      // },
      gallary: this.childrensRu.gallary,
    };
  },
  components: {
    GallaryImg,
  ...
  computed: {
    imageSrc() {
      if (this.childrensRu.mainImg.localUrl) {
        return this.childrensRu.mainImg.localUrl;
      }
      if (this.childrensRu.mainImg.imgUrl) {
        return this.childrensRu.mainImg.imgUrl;
      } else {
        return defaultImg;
      }
    },
  ...
  watch: {
    childrensRu: {
      handler(childrensRu) {
        this.gallary = childrensRu.gallary;
      },
    },
  },
  methods: {
    ...
    previewMain() {
      if (!this.$refs.mainImg || !this.$refs.mainImg.files?.length) {
        this.childrensRu.mainImg.img = "";
        this.childrensRu.mainImg.localUrl = "";
        return;
      }
      const file = this.$refs.mainImg.files[0];
      const reader = new FileReader();
      this.childrensRu.mainImg.img = file;
      reader.onload = (ev) => {
        if (!this.childrensRu.mainImg.id) {
          this.childrensRu.mainImg.id = new Date().valueOf();
        }
        this.childrensRu.mainImg.localUrl = ev.currentTarget.result;
      };
    ...
    imgMainRemove() {
      this.mainImg.file = "";
      this.childrensRu.mainImg.url = "";
      this.childrensRu.mainImg.mainLocal = "";
      this.childrensRu.mainImg.img = "";
      this.mainImg.id = "";
    },
  },
