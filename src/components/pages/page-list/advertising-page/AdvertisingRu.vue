    ...
    <div class="card-page">
      <div class="card-page__content">
        ...
        <div class="card-page__description">
          <span>Описание</span>
          <textarea
            v-model="advertisingRu.description"
          ...
          <div class="card-page__seo-block">
            ...
            <div class="card-page__seo-input">
              ...
              <p>
                Title:
                <input
                  v-model="advertisingRu.seoTitle"
                  type="text"
                  placeholder="Title"
                />
              </p>
              <p class="keywords">
                Keywords:
                <input
                  v-model="advertisingRu.seoKeywords"
                  type="text"
                  placeholder="word"
                />
              </p>
              <p class="card-page__seo-description">
                Description:<textarea
                  v-model="advertisingRu.seoDescription"
...
export default {
  data() {
    return {
      ...
      //   mainLocal: "",
      // },
      gallary: this.advertisingRu.gallary,
    };
  },
  components: {
    GallaryImg,
  ...
  computed: {
    imageSrc() {
      if (this.advertisingRu.mainImg.localUrl) {
        return this.advertisingRu.mainImg.localUrl;
      }
      if (this.advertisingRu.mainImg.imgUrl) {
        return this.advertisingRu.mainImg.imgUrl;
      } else {
        return defaultImg;
      }
    },
  ...
  watch: {
    advertisingRu: {
      handler(advertisingRu) {
        this.gallary = advertisingRu.gallary;
      },
    },
  },
  methods: {
    ...
    previewMain() {
      if (!this.$refs.mainImg || !this.$refs.mainImg.files?.length) {
        this.advertisingRu.mainImg.img = "";
        this.advertisingRu.mainImg.localUrl = "";
        return;
      }
      const file = this.$refs.mainImg.files[0];
      const reader = new FileReader();
      this.advertisingRu.mainImg.img = file;
      reader.onload = (ev) => {
        if (!this.advertisingRu.mainImg.id) {
          this.advertisingRu.mainImg.id = new Date().valueOf();
        }
        this.advertisingRu.mainImg.localUrl = ev.currentTarget.result;
      };
    ...
    imgMainRemove() {
      this.mainImg.file = "";
      this.advertisingRu.mainImg.url = "";
      this.advertisingRu.mainImg.mainLocal = "";
      this.advertisingRu.mainImg.img = "";
      this.mainImg.id = "";
    },
  },
