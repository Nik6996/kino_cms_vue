    ...
    <div class="news">
      <div class="news__content">
        ...
        <div class="news__description">
          <span>Опис</span>
          <textarea v-model="newsUa.description" placeholder="Опис"></textarea>
        </div>
        ...
        <div class="news__seo">
          <div class="news__seo-block">
            ...
            <div class="news__seo-input">
              <p>
                URL:
                <input v-model="newsUa.seoUrl" type="text" placeholder="URL" />
              </p>
              <p>
                Title:
                <input
                  v-model="newsUa.seoTitle"
                  type="text"
                  placeholder="Title"
                />
              </p>
...
export default {
  ...
  computed: {
    imageSrc() {
      if (this.newsUa.mainImg.mainLocal) {
        return this.newsUa.mainImg.mainLocal;
      }
      if (this.newsUa.mainImg.imgUrl) {
        return this.newsUa.mainImg.imgUrl;
      } else {
        return defaultImg;
      }
    },
  ...
  watch: {
    newsUa: {
      handler(newsUa) {
        this.gallary = newsUa.gallary;
        this.date = this.newsUa.date;
      },
    },
    date: {
      handler(date) {
        this.newsUa.date = date;
      },
    },
  },
  ...
  methods: {
    ...
    previewLogo() {
      ...
      this.newsUa.mainImg.img = file;
      reader.onload = (ev) => {
        this.mainImg.file = file;
        if (!this.newsUa.mainImg.id) {
          this.newsUa.mainImg.id = new Date().valueOf();
        }
        this.newsUa.mainImg.mainLocal = ev.currentTarget.result;
      };
    ...
    imgMainRemove() {
      this.mainImg.file = "";
      this.newsUa.mainImg.url = "";
      this.newsUa.mainImg.mainLocal = "";
      this.newsUa.mainImg.img = "";
      this.mainImg.id = "";
    },
  },
};
